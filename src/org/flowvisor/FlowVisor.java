...
public class FlowVisor {
	...
	private WebServer apiServer;//è di apachi
	...
	public void run() throws ConfigError, IOException, UnhandledEvent {
		...
		if (port == 0)
			port = FVConfig.getListenPort();//FVConfig chiama Flowvisorimpl che a sua volta chiama FVConfigurationController
		...
		// init switchAcceptor
		OFSwitchAcceptor acceptor = new OFSwitchAcceptor(pollLoop, port, 16);//crea la connessione e la binda() e richiama register in EventLoop()
		handlers.add(acceptor);//da controllare questo ADD dato che quando crea l'istanza di OFSwitchAcceptator fa al suo interno un addHandler della stessa istanza sembra.... da indagare.
	...
	public static void main(String args[]) throws Throwable {
		...
		FVConfigurationController.init(new ConfDBHandler());// settiamo le informazioni del DB
		while (true) {
