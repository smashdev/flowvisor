...
public class FVPacketOut extends OFPacketOut implements Classifiable, Slicable {
	...
	public void sliceFromController(FVClassifier fvClassifier, FVSlicer fvSlicer) {
		...
		if (packet != null && packet.length > 0) {//serve a controllare che il pacchetto contenga dei dati e non sia vuoto
			try {
				match.loadFromPacket(this.getPacketData(), OFPort.OFPP_ALL.getValue()); //gli passiamo dati e porta
